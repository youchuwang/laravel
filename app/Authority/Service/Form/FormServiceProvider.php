...
use Authority\Service\Form\AddAutoCheck\AddAutoCheckForm;
use Authority\Service\Form\AddAutoCheck\AddAutoCheckFormLaravelValidator;
...
class FormServiceProvider extends ServiceProvider {
    ...
    public function register()
    {
        ...
        // Bind the Add Auto Check Form
        $app->bind('Authority\Service\Form\AddAutoCheck\AddAutoCheckForm', function($app)
        {
            return new AddAutoCheckForm(
                new AddAutoCheckFormLaravelValidator($app['validator'], new \UserSiteInfo,$app->make('Authority\Repo\User\UserInterface')) 
            );
        });
        // Bind the Group Form
