...
<html>
<head>
	<title>Verify your alert email</title>
                                        ...
                                        <table cellpadding="20" cellspacing="0" border="0" style="width: 100%; min-height: 350px; font-family: Arial, Verdana, sans-serif;">
                                            <tr>
                                                ...
                                                <td valign="top" width="450">
                                                    <h1 style="font-family: Arial, Verdana, sans-serif; font-size: 22px; color: #555555;">Verify your alert email.</h1>
                                                    <p style="color: #555555; font-size: 12px; line-height: 20px;">
                                                        To verify  <a href="mailto:{{{ $email }}}" style="color: #555555; font-weight: bold; text-decoration: none;"><span>{{{ $email }}}</span></a>  as your alert email, click this link:
                                                        <br />
                                                        <br />
