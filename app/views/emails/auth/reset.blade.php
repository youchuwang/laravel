                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" width="450">
                                                    ...
                                                    <p style="color: #555555; font-size: 12px; line-height: 20px;">
                                                        To reset your password, <a href="{{ URL::to('users') }}/{{ $userId }}/reset/{{ urlencode($resetCode) }}" style="outline: none; color: #00aeef; font-weight: bold; text-decoration: none;">click here.</a>  If you did not request a password reset, you can safely ignore this email - nothing will be changed.
														<br/>
														<br/>
														Or point your browser to this address: <br /> {{ URL::to('users') }}/{{ $userId }}/reset/{{ urlencode($resetCode) }}
                                                        <br />
                                                        <br />
                                                    </p>
                                                </td>
