                                        ...
                                        <table cellpadding="20" cellspacing="0" border="0" style="width: 100%; min-height: 350px; font-family: Arial, Verdana, sans-serif;">
                                            <tr>
                                                ...
                                                <td valign="top" width="450">
                                                    <h1 style="font-family: Arial, Verdana, sans-serif; font-size: 22px; color: #555555;">{{ $title }}</h1>
                                                    <p>Your url that we monitor</p>
                                                    <p>{{ $alert_email->url }}</p>
                                                    <p>has been down for {{ $downtime/60 }} minutes</p>
                                                    <p>since {{ $time_formatted }}.</p>                                                    
													<p>The error message was</p>
                                                    <p>{{ $last_checked_status }} - {{ $last_error_message }}</p>
                                                </td>
                                        ...
                                        <table cellspacing="0" border="0" cellpadding="20" width="100%" style="border-top: 1px solid #c0c0c0;">
                                            <tr>
                                                <td align="left" valign="middle" style="font-size: 11px; line-height: 16px; font-family: Arial, Verdana, sans-serif; color: #666666;">
                                                    <strong>Questions?</strong> <a href="http://dev.keepusup.com/contact-support" style="outline: none; color: #00aeef; font-weight: bold; text-decoration: none;">Contact Customer Support</a>.<br />
